...
The best model, based on Akaike’s Information Criterion (AIC), includes both season and distance from the forest edge (model1) as predictors of Swift Parrot nest box occupancy. This model provides the best balance of signal (meaningful information) to noise (random variation).
...
# View predictions data frame to inspect its structure and values
...
**Figure 1.** Predicted probabilities and 95% confidence intervals from the best model of nest box occupancy by Swift Parrots, the target species of the restoration effort. The plot shows how the probability of occupancy changes with distance from the forest edge and between study years (2016 and 2019). Occupancy probability decreases with increasing distance from the forest edge and from 2016 to 2019.
...
Swift Parrots are more likely to occupy nest boxes located closer to the forest edge and showed reduced occupancy in 2019 compared to 2016 (see *Figure 1* and *Table 1*). For every 1-meter increase in distance from the forest edge, the odds of occupancy decrease by a factor of 0.998 (95% CI [1.00, 1.00], *p* < 0.001). At 0 meters, the predicted probability of occupancy was 0.481 in 2016 and 0.298 in 2019, decreasing to 0.125 and 0.061, respectively, at 900 meters.

These patterns suggest that the declining occupancy of Swift Parrots may be driven by increasing competition for nesting sites, particularly from invasive species such as starlings and tree martins, consistent with previous findings reported in the study.
